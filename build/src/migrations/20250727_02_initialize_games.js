...
function up(_a) {
    return __awaiter(this, arguments, void 0, function* ({ context: queryInterface }) {
        yield queryInterface.createTable('games', {
            ...
            player_1_id: { type: sequelize_1.DataTypes.UUID, references: { model: 'users', key: 'id' }, allowNull: false },
            player_2_id: { type: sequelize_1.DataTypes.UUID, references: { model: 'users', key: 'id' }, allowNull: false },
            winner_id: { type: sequelize_1.DataTypes.UUID, references: { model: 'users', key: 'id' } },
