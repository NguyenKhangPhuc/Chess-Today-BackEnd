...
function up(_a) {
    return __awaiter(this, arguments, void 0, function* ({ context: queryInterface }) {
        yield queryInterface.createTable('verification', {
            id: {
                allowNull: false,
                primaryKey: true,
            ...
            hash_token: { type: sequelize_1.DataTypes.TEXT, allowNull: false },
            expired_at: { type: sequelize_1.DataTypes.DATE, allowNull: false },
...
function down(_a) {
    return __awaiter(this, arguments, void 0, function* ({ context: queryInterface }) {
        yield queryInterface.dropTable('verification');
    });
}
